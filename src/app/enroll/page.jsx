        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <select
              name="modeOfLearning"
              onChange={handleChange}
              className={`w-full p-3 rounded-lg bg-white text-black border ${errors.mode ? "border-red-500" : "border-gray-300"
                } outline-none focus:ring-2 focus:ring-[#da2721]`}
            >
          ...
          <div>
            <select
              name="course"
              onChange={handleChange}
              className={`w-full p-3 rounded-lg bg-white text-black border ${errors.course ? "border-red-500" : "border-gray-300"
                } outline-none focus:ring-2 focus:ring-[#da2721]`}
            >
